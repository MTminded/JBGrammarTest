        ...
        <script src="<?php echo asset_url();?>js/audiodisplay.js"></script>
   		
        <script src="<?php echo asset_url();?>js/record.js"></script>	
        <script src="<?php echo asset_url();?>js/recorderjs/recorder.js"></script>		
	</body>
</html>
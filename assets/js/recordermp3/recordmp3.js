(function(global) {
  ...
  var initWorker = function() {
    WORKER_PATH = WORKER_PATH || global.workerPath + 'js/recordermp3/recorderWorker.js';
    try {
      encoderWorker = encoderWorker || new Worker(global.workerPath + 'js/recordermp3/mp3Worker.js');
    } catch (e) {
